            ...
            <Card>
                <CardHeader className="flex flex-row xs:flex-wrap md:flex-nowrap justify-between gap-6">
                    <div className="md:max-w-[600px]">
                        <CardTitle>Create your data Destination</CardTitle>
                                                    ...
                                                    <Dialog key={index}>
                                                        <DialogTrigger>
                                                           <div className="cursor-pointer rounded-md border p-4 flex flex-col gap-4 h-[148px] max-w-[267px]">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <h4 className="text-sm text-left">{card.titel}</h4>
                                                                </div>
                                                                <p className="h-[47px] line-clamp-2 text-left text-[12px] text-[#757575]">{card.text}</p>
                                                            </div>
                                                        </DialogTrigger>
                                                        <DialogContent className="max-w-[650px]">
                                                            <DialogHeader className="mb-6">
                                                                ...
                                                                <DialogDescription className="max-w-[550px]">
                                                            ...
                                                            <div className="border-y-2 py-6 flex flex-col gap-8">
                                                                ...
                                                                <div className="flex flex-col gap-0.5">
                                                                   <h4 className="font-[600] text-[#0E1B26]">Example use cases</h4>
                                                                   <ul className="text-sm list-disc list-inside text-[#757575]">
